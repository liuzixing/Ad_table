...
function getSQLString() {
    return
"select mm.cpvi as cpvi, mm.nb as positif, mm1.nb as total, mm.client, mm1.channel, mm.mmdaypart as MMDayPart,mm.campaign as campaign,dmin,dmax, mm1.weekday as WEEKDAY from (( select (sum(`budgetnet`) / sum( `apres-count1` - `avant-count1` )) AS cpvi , sum(`avant-count1`) ,client, campaign ,count(*) as nb, channel,
(
    CASE
WHEN (
dayofweek(date)=1
